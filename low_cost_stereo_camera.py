...
pathL = "C:/Records/Local Records/underwater_calibration/left/"
pathR = "C:/Records/Local Records/underwater_calibration/right/"
...
for fn in tqdm.tqdm(os.listdir(pathL)):
    ...
    if retR and retL:
        ...
        break
print(len(img_ptsL))
# pickle.dump(img_ptsL, open('img_ptsL_230102.pkl','wb'))
# pickle.dump(img_ptsR, open('img_ptsR_230102.pkl','wb'))
# pickle.dump(obj_pts, open('obj_pts_230102.pkl','wb'))
img_ptsL = pickle.load(open('img_ptsL_230102.pkl','rb'))
img_ptsR = pickle.load(open('img_ptsR_230102.pkl','rb'))
obj_pts = pickle.load(open('obj_pts_230102.pkl','rb'))
# print(len(obj_pts))
# exit()
...
# cv_file = cv2.FileStorage("params_230102.xml", cv2.FILE_STORAGE_WRITE)
